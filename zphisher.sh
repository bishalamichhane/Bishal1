...
#  | __ )(_)___| |__   __ _| | | |    __ _ _ __ ___ (_) ___| |__ | |__   __ _ _ __   ___    

#  |  _ \| / __| '_ \ / _` | | | |   / _` | '_ ` _ \| |/ __| '_ \| '_ \ / _` | '_ \ / _ \   

#  | |_) | \__ \ | | | (_| | | | |__| (_| | | | | | | | (__| | | | | | | (_| | | | |  __/   

#  |____/|_|___/_| |_|\__,_|_| |_____\__,_|_| |_| |_|_|\___|_| |_|_| |_|\__,_|_| |_|\___|   
...
${GREEN} Author   ${RED}:  ${ORANGE}Bishal Lamichhane AT ${RED}[ ${ORANGE} White Devil ${RED}] 
...
${WHITE} ${CYANBG}THINGS TO BE NOTED:${RESETBG} 

${GREEN}  I won't be responsible if something happens to anyone  
